...
class ExpConfig:
    ...
    STEPS_PER_CHECKPOINT = 5000 # checkpointing (print perplexity, save model) per how many steps
    ...
    ATTN_NUM_HIDDEN=256#128 # number of hidden units in attention decoder cell
    ATTN_NUM_LAYERS = 3#2 # number of layers in attention decoder cell
